...
#define time MercuryTime
#define localtime MercuryTime
#define gmtime MercuryGMtime
...
time_t MercuryTime(time_t *_timer);
struct tm *MercuryLocaltime(const time_t *pEporchSec);
struct tm *MercuryGMtime(const time_t *pEporchSec);
//  ��ȡus�����tick,����ֻ�е�32λ��Ч
int64_t MercuryTimeTickUS(void);
