...
//external error code
#define ERROR_NV_CRC_CHECK_ERROR                        0x800a0008
#define ERROR_NV_INVALID_HEADF_MSG                      0x800a0009
#define ERROR_NV_NOT_ENOUGH_MEMORY                      0x800a000a
#define ERROR_NV_READ_FAIL                              0x800a000b
#define ERROR_NV_WRITE_HEAD_FAIL                        0x800a000c
#define ERROR_NV_WRITE_FAIL                             0x800a000e
...
#define ERROR_SMS_NOT_READY                         0x800d000a
...
#define	FILE_EPERM           ERROR_FILE_BASE_ERROR + 1		/* Not owner */
#define	FILE_ENOENT          ERROR_FILE_BASE_ERROR + 2	/* No such file or directory */
#define	FILE_ESRCH           ERROR_FILE_BASE_ERROR + 3		/* No such process */
#define	FILE_EINTR           ERROR_FILE_BASE_ERROR + 4		/* Interrupted system call */
#define	FILE_EIO             ERROR_FILE_BASE_ERROR + 5		/* I/O error */
#define	FILE_ENXIO           ERROR_FILE_BASE_ERROR + 6		/* No such device or address */
#define	FILE_E2BIG           ERROR_FILE_BASE_ERROR + 7		/* Arg list too long */
#define	FILE_ENOEXEC         ERROR_FILE_BASE_ERROR + 8	/* Exec format error */
#define	FILE_EBADF           ERROR_FILE_BASE_ERROR + 9		/* Bad file number */
#define	FILE_ECHILD          ERROR_FILE_BASE_ERROR + 10	/* No children */
#define	FILE_EAGAIN          ERROR_FILE_BASE_ERROR + 11	/* No more processes */
#define	FILE_ENOMEM          ERROR_FILE_BASE_ERROR + 12	/* Not enough space */
#define	FILE_EACCES          ERROR_FILE_BASE_ERROR + 13	/* Permission denied */
#define	FILE_EFAULT          ERROR_FILE_BASE_ERROR + 14	/* Bad address */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_ENOTBLK         ERROR_FILE_BASE_ERROR + 15	/* Block device required */
#endif
#define	FILE_EBUSY           ERROR_FILE_BASE_ERROR + 16	/* Device or resource busy */
#define	FILE_EEXIST          ERROR_FILE_BASE_ERROR + 17	/* File exists */
#define	FILE_EXDEV           ERROR_FILE_BASE_ERROR + 18	/* Cross-device link */
#define	FILE_ENODEV          ERROR_FILE_BASE_ERROR + 19	/* No such device */
#define	FILE_ENOTDIR         ERROR_FILE_BASE_ERROR + 20	/* Not a directory */
#define	FILE_EISDIR          ERROR_FILE_BASE_ERROR + 21	/* Is a directory */
#define	FILE_EINVAL          ERROR_FILE_BASE_ERROR + 22	/* Invalid argument */
#define	FILE_ENFILE          ERROR_FILE_BASE_ERROR + 23	/* Too many open files in system */
#define	FILE_EMFILE          ERROR_FILE_BASE_ERROR + 24	/* File descriptor value too large */
#define	FILE_ENOTTY          ERROR_FILE_BASE_ERROR + 25	/* Not a character device */
#define	FILE_ETXTBSY         ERROR_FILE_BASE_ERROR + 26	/* Text file busy */
#define	FILE_EFBIG           ERROR_FILE_BASE_ERROR + 27	/* File too large */
#define	FILE_ENOSPC          ERROR_FILE_BASE_ERROR + 28	/* No space left on device */
#define	FILE_ESPIPE          ERROR_FILE_BASE_ERROR + 29	/* Illegal seek */
#define	FILE_EROFS           ERROR_FILE_BASE_ERROR + 30	/* Read-only file system */
#define	FILE_EMLINK          ERROR_FILE_BASE_ERROR + 31	/* Too many links */
#define	FILE_EPIPE           ERROR_FILE_BASE_ERROR + 32	/* Broken pipe */
#define	FILE_EDOM            ERROR_FILE_BASE_ERROR + 33		/* Mathematics argument out of domain of function */
#define	FILE_ERANGE          ERROR_FILE_BASE_ERROR + 34	/* Result too large */
#define	FILE_ENOMSG          ERROR_FILE_BASE_ERROR + 35	/* No message of desired type */
#define	FILE_EIDRM           ERROR_FILE_BASE_ERROR + 36	/* Identifier removed */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_ECHRNG          ERROR_FILE_BASE_ERROR + 37	/* Channel number out of range */
#define	FILE_EL2NSYNC        ERROR_FILE_BASE_ERROR + 38	/* Level 2 not synchronized */
#define	FILE_EL3HLT          ERROR_FILE_BASE_ERROR + 39	/* Level 3 halted */
#define	FILE_EL3RST          ERROR_FILE_BASE_ERROR + 40	/* Level 3 reset */
#define	FILE_ELNRNG          ERROR_FILE_BASE_ERROR + 41	/* Link number out of range */
#define	FILE_EUNATCH         ERROR_FILE_BASE_ERROR + 42	/* Protocol driver not attached */
#define	FILE_ENOCSI          ERROR_FILE_BASE_ERROR + 43	/* No CSI structure available */
#define	FILE_EL2HLT          ERROR_FILE_BASE_ERROR + 44	/* Level 2 halted */
#endif
#define	FILE_EDEADLK         ERROR_FILE_BASE_ERROR + 45	/* Deadlock */
#define	FILE_ENOLCK          ERROR_FILE_BASE_ERROR + 46	/* No lock */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_EBADE           ERROR_FILE_BASE_ERROR + 50	/* Invalid exchange */
#define	FILE_EBADR           ERROR_FILE_BASE_ERROR + 51	/* Invalid request descriptor */
#define	FILE_EXFULL          ERROR_FILE_BASE_ERROR + 52	/* Exchange full */
#define	FILE_ENOANO          ERROR_FILE_BASE_ERROR + 53	/* No anode */
#define	FILE_EBADRQC         ERROR_FILE_BASE_ERROR + 54	/* Invalid request code */
#define	FILE_EBADSLT         ERROR_FILE_BASE_ERROR + 55	/* Invalid slot */
#define	FILE_EDEADLOCK       ERROR_FILE_BASE_ERROR + 56	/* File locking deadlock error */
#define	FILE_EBFONT          ERROR_FILE_BASE_ERROR + 57	/* Bad font file fmt */
#endif
#define	FILE_ENOSTR          ERROR_FILE_BASE_ERROR + 60	/* Not a stream */
#define	FILE_ENODATA         ERROR_FILE_BASE_ERROR + 61	/* No data (for no delay io) */
#define	FILE_ETIME           ERROR_FILE_BASE_ERROR + 62	/* Stream ioctl timeout */
#define	FILE_ENOSR           ERROR_FILE_BASE_ERROR + 63	/* No stream resources */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_ENONET          ERROR_FILE_BASE_ERROR + 64	/* Machine is not on the network */
#define	FILE_ENOPKG          ERROR_FILE_BASE_ERROR + 65	/* Package not installed */
#define	FILE_EREMOTE         ERROR_FILE_BASE_ERROR + 66	/* The object is remote */
#endif
#define	FILE_ENOLINK         ERROR_FILE_BASE_ERROR + 67	/* Virtual circuit is gone */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_EADV            ERROR_FILE_BASE_ERROR + 68		/* Advertise error */
#define	FILE_ESRMNT          ERROR_FILE_BASE_ERROR + 69	/* Srmount error */
#define	FILE_ECOMM           ERROR_FILE_BASE_ERROR + 70	/* Communication error on send */
#endif
#define	FILE_EPROTO          ERROR_FILE_BASE_ERROR + 71	/* Protocol error */
#define	FILE_EMULTIHOP       ERROR_FILE_BASE_ERROR + 74	/* Multihop attempted */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_ELBIN           ERROR_FILE_BASE_ERROR + 75	/* Inode is remote (not really error) */
#define	FILE_EDOTDOT         ERROR_FILE_BASE_ERROR + 76	/* Cross mount point (not really error) */
#endif
#define	FILE_EBADMSG         ERROR_FILE_BASE_ERROR + 77	/* Bad message */
#define	FILE_EFTYPE          ERROR_FILE_BASE_ERROR + 79	/* Inappropriate file type or format */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_ENOTUNIQ        ERROR_FILE_BASE_ERROR + 80	/* Given log. name not unique */
#define	FILE_EBADFD          ERROR_FILE_BASE_ERROR + 81	/* f.d. invalid for this operation */
#define	FILE_EREMCHG         ERROR_FILE_BASE_ERROR + 82	/* Remote address changed */
#define	FILE_ELIBACC         ERROR_FILE_BASE_ERROR + 83	/* Can't access a needed shared lib */
#define	FILE_ELIBBAD         ERROR_FILE_BASE_ERROR + 84	/* Accessing a corrupted shared lib */
#define	FILE_ELIBSCN         ERROR_FILE_BASE_ERROR + 85	/* .lib section in a.out corrupted */
#define	FILE_ELIBMAX         ERROR_FILE_BASE_ERROR + 86	/* Attempting to link in too many libs */
#define	FILE_ELIBEXEC        ERROR_FILE_BASE_ERROR + 87	/* Attempting to exec a shared library */
#endif
#define	FILE_ENOSYS          ERROR_FILE_BASE_ERROR + 88	/* Function not implemented */
#ifdef __CYGWIN__
#define	FILE_ENMFILE         ERROR_FILE_BASE_ERROR + 89      /* No more files */
#endif
#define	FILE_ENOTEMPTY       ERROR_FILE_BASE_ERROR + 90	/* Directory not empty */
#define	FILE_ENAMETOOLONG    ERROR_FILE_BASE_ERROR + 91	/* File or path name too long */
#define	FILE_ELOOP           ERROR_FILE_BASE_ERROR + 92	/* Too many symbolic links */
#define	FILE_EOPNOTSUPP      ERROR_FILE_BASE_ERROR + 95	/* Operation not supported on socket */
#define	FILE_EPFNOSUPPORT    ERROR_FILE_BASE_ERROR + 96 /* Protocol family not supported */
#define	FILE_ECONNRESET      ERROR_FILE_BASE_ERROR + 104  /* Connection reset by peer */
#define	FILE_ENOBUFS         ERROR_FILE_BASE_ERROR + 105	/* No buffer space available */
#define	FILE_EAFNOSUPPORT    ERROR_FILE_BASE_ERROR + 106 /* Address family not supported by protocol family */
#define	FILE_EPROTOTYPE      ERROR_FILE_BASE_ERROR + 107	/* Protocol wrong type for socket */
#define	FILE_ENOTSOCK        ERROR_FILE_BASE_ERROR + 108	/* Socket operation on non-socket */
#define	FILE_ENOPROTOOPT     ERROR_FILE_BASE_ERROR + 109	/* Protocol not available */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_ESHUTDOWN       ERROR_FILE_BASE_ERROR + 110	/* Can't send after socket shutdown */
#endif
#define	FILE_ECONNREFUSED    ERROR_FILE_BASE_ERROR + 111	/* Connection refused */
#define	FILE_EADDRINUSE      ERROR_FILE_BASE_ERROR + 112		/* Address already in use */
#define	FILE_ECONNABORTED    ERROR_FILE_BASE_ERROR + 113	/* Software caused connection abort */
#define	FILE_ENETUNREACH     ERROR_FILE_BASE_ERROR + 114		/* Network is unreachable */
#define	FILE_ENETDOWN        ERROR_FILE_BASE_ERROR + 115		/* Network interface is not configured */
#define	FILE_ETIMEDOUT       ERROR_FILE_BASE_ERROR + 116		/* Connection timed out */
#define	FILE_EHOSTDOWN       ERROR_FILE_BASE_ERROR + 117		/* Host is down */
#define	FILE_EHOSTUNREACH    ERROR_FILE_BASE_ERROR + 118	/* Host is unreachable */
#define	FILE_EINPROGRESS     ERROR_FILE_BASE_ERROR + 119		/* Connection already in progress */
#define	FILE_EALREADY        ERROR_FILE_BASE_ERROR + 120		/* Socket already connected */
#define	FILE_EDESTADDRREQ    ERROR_FILE_BASE_ERROR + 121	/* Destination address required */
#define	FILE_EMSGSIZE        ERROR_FILE_BASE_ERROR + 122		/* Message too long */
#define	FILE_EPROTONOSUPPORT  ERROR_FILE_BASE_ERROR + 123	/* Unknown protocol */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_ESOCKTNOSUPPORT  ERROR_FILE_BASE_ERROR + 124	/* Socket type not supported */
#endif
#define	FILE_EADDRNOTAVAIL   ERROR_FILE_BASE_ERROR + 125	/* Address not available */
#define	FILE_ENETRESET       ERROR_FILE_BASE_ERROR + 126		/* Connection aborted by network */
#define	FILE_EISCONN         ERROR_FILE_BASE_ERROR + 127		/* Socket is already connected */
#define	FILE_ENOTCONN        ERROR_FILE_BASE_ERROR + 128		/* Socket is not connected */
#define	FILE_ETOOMANYREFS    ERROR_FILE_BASE_ERROR + 129
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_EPROCLIM        ERROR_FILE_BASE_ERROR + 130
#define	FILE_EUSERS          ERROR_FILE_BASE_ERROR + 131
#endif
#define	FILE_EDQUOT          ERROR_FILE_BASE_ERROR + 132
#define	FILE_ESTALE          ERROR_FILE_BASE_ERROR + 133
#define	FILE_ENOTSUP         ERROR_FILE_BASE_ERROR + 134		/* Not supported */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_ENOMEDIUM       ERROR_FILE_BASE_ERROR + 135   /* No medium (in tape drive) */
#endif
#ifdef __CYGWIN__
#define	FILE_ENOSHARE        ERROR_FILE_BASE_ERROR + 136    /* No such host or network path */
#define	FILE_ECASECLASH      ERROR_FILE_BASE_ERROR + 137  /* Filename exists with different case */
#endif
#define	FILE_EILSEQ          ERROR_FILE_BASE_ERROR + 138		/* Illegal byte sequence */
#define	FILE_EOVERFLOW       ERROR_FILE_BASE_ERROR + 139	/* Value too large for defined data type */
#define	FILE_ECANCELED       ERROR_FILE_BASE_ERROR + 140	/* Operation canceled */
#define	FILE_ENOTRECOVERABLE  ERROR_FILE_BASE_ERROR + 141	/* State not recoverable */
#define	FILE_EOWNERDEAD      ERROR_FILE_BASE_ERROR + 142	/* Previous owner died */
#ifdef __LINUX_ERRNO_EXTENSIONS__
#define	FILE_ESTRPIPE        ERROR_FILE_BASE_ERROR + 143	/* Streams pipe error */
#endif
