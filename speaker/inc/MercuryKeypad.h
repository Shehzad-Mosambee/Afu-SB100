...
INT KP_Init(void);
INT KP_Deinit(void);
INT KP_RegisterApp(KEYPAD_UID_E uid, LPVOID kpCallback);
...
void KP_SetPowerKeyAction(int isHasLcd);
MC_PWK_STATE_E KP_PowKeyState(void);
void KP_PowKeyLongPressTimeSet(int time);
