...
extern void TimerCountdownMS(Timer*, ULONG);
extern void TimerCountdown(Timer*, ULONG);
...
typedef struct MQTTClient
{
    ...
    unsigned int ping_resp_timeout_ms;
    size_t buf_size,
      readbuf_size;
    unsigned char buf[1024];
    unsigned char readbuf[1024];
    unsigned int connect_AliveInterval;
    ...
    void (*lost_Call_back)(void*, const char *);
    Network* ipstack;
...
DLLExport void MQTTClientInit(MQTTClient* client, Network* network, unsigned int command_timeout_ms,
		unsigned char* sendbuf, size_t sendbuf_size, unsigned char* readbuf, size_t readbuf_size, unsigned int ping_timeout_ms);
