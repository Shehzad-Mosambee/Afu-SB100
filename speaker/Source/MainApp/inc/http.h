...
#ifdef MERCURY_PLATFORM
HTTP_API int ft_http_sync_download_file( ft_http_client_t* http, const char* url, const char* filepath, const char *user_header, int user_header_len );
HTTP_API int ft_http_sync_post_data( ft_http_client_t *http, unsigned long handle, const char *url, unsigned char* post_data, int post_len, const char *user_header, int user_header_len , unsigned int timeout);
...
HTTP_API int ft_http_sync_post_file(ft_http_client_t* http, const char* url,  const char* post_data, int post_data_len);
